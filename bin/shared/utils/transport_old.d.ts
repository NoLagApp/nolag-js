...
export declare const toRecordSeparator: (recordArray: Uint8Array[]) => Uint8Array<ArrayBufferLike>;
export declare const stringToUint8Array: (str: string) => Uint8Array;
export declare const toGroupSeparator: (records: Uint8Array, data: ArrayBuffer) => ArrayBuffer;
